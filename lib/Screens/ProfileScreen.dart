...
import 'package:healthy_bites/Screens/ProfileImagePickerScreen.dart';
...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  _launchURL() async {
    var url = Uri.parse("https://github.com/ammad-naseer");
            ...
            Column(
              children: [
                InkWell(
                    ...
                    child:
                        drawerText("Change Email", Icons.lock_open_outlined)),
                InkWell(
                    onTap: () {
                      editPasswordDialog();
                    },
